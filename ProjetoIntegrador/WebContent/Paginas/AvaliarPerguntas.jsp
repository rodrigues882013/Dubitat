...
<%
	...
	if(T != null){
		...
		String atualizar = "Cadastro.jsp?" + "Nome="+ nome + "&Matricula=" + matricula + "&Email=" + T.getEmail();
  ...
  <% ArrayList<Pergunta> pergunta = new ArrayList<Pergunta>();
	...
	Iterator it2 = disciplina.iterator();
  	while(it2.hasNext()){
		...
		if(PerguntaBD.retornaPerguntaPendenteDeAprovacao(s) != null){
			pergunta.addAll(PerguntaBD.retornaPerguntaPendenteDeAprovacao(s));
		}
	}
  	if(!pergunta.isEmpty()){
  %>
	...
	<div class="login" id="login"> 
     ...
     <table style="margin-left:-100px;">
  	...
  	<tr>
  		...
  		<%
  			String editar = "EditarPergunta.jsp?ticket=" + ticket + "&msg=" + msg + "&disc=" + disc + "&prio=" + prio;
  		%>
  		<td><a href="<%=editar %>">Analizar</a></td>
  		<td><a href="../ExcluirPerguntaServlet?ticket=<%=ticket%>"><img src="../Imagens/excluir.png"></a></td>
  		<td><a href="../LiberarPerguntaServlet?ticket=<%=ticket %>"><img src="../Imagens/incluir.png"></a></td>
