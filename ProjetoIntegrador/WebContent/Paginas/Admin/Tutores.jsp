...
<%
	ArrayList<Tutor> M =  (ArrayList<Tutor>) session.getAttribute("tutores");
%>
...
<div class="corpo" id="corpo">
	 ...
	 <!-- Login -->
      ...
      <div class="login" id="login"> 
  	  ...
  	  <strong>Lista de Tutores cadastrados no sistema</strong><br><br>
    <table>
    	<tr>
    		<th>Matricula</th>
    		<th>Nome</th>
		...
		Iterator<Tutor> it = M.iterator();
  		while(it.hasNext()){ 
  			Tutor p = (Tutor) it.next();
