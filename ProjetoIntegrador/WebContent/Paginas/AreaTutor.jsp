...
<div class="corpo" id="corpo">
   ...
   <!-- Botoes de Acesso rápido -->
      <div class="botoes" id="botoes">
      	<center>
      		<img src="../Imagens/bt_tutor.png" width="808" height="165" border="0" align="absmiddle" usemap="#Map" />
        	<map name="Map" id="Map">
      			<!--Demarcação dos botões -->
        		<area shape="rect" coords="16,21,139,141" href=<%=atualizar %>/> 
        		<area shape="rect" coords="184,17,508,142" href="../DisciplinaServlet4" />
        		<area shape="rect" coords="354,18,676,142" href="ListaDeMonitores.jsp"/>
        		<area shape="rect" coords="354,18,800,142" href="#" />
     	 	</map>
      	</center>
      </div>   
       <!--Fecha div botoes -->
